...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '答辩小组教师关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `defense_group_teacher` VALUES (33, 1, 24, 1, '2026-01-03 15:36:55');
...
-- ----------------------------
INSERT INTO `t_student` VALUES (2, '20210002', '周雨桐', '计科2002', 1, 2, 1, 'DESIGN', '智能助老 APP 设计', '便捷健康监测与陪伴。', 1, 2024, '13800000001', 'zhouyt@example.com', '2025-06-20', '2025-12-18 12:38:58', '2026-01-03 15:53:58');
INSERT INTO `t_student` VALUES (3, '20210003', '陈思琪', '软工2001', 1, 3, 4, 'PAPER', '微服务网关安全加固', '零信任与熔断策略结合。', 2, 2024, '13800000002', 'chensq@example.com', '2025-06-20', '2025-12-18 12:38:58', '2026-01-03 15:56:27');
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '教师表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `teacher` VALUES (24, 'T013', '王五', 1, NULL, NULL, NULL, '$2a$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 1, 30, '2026-01-03 15:35:39', '2026-01-03 15:44:43');
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '教师打分记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `teacher_score_record` VALUES (22, 2, 1, 24, 2024, 15, 13, 12, 25, 15, 15, 95, '2026-01-03 15:46:22', '2026-01-03 15:46:22');
INSERT INTO `teacher_score_record` VALUES (23, 9, 1, 24, 2024, 50, 24, 23, NULL, NULL, NULL, 97, '2026-01-03 15:46:30', '2026-01-03 15:46:30');
...
INSERT INTO `user` VALUES (30, 'T013', '$2a$10$g2wkN7ssThzXj6iru5WFYuQTbTOKP3ygt1Q96tPqAd6PBISt2Uzba', '王五', NULL, NULL, 1, 4, 1, '2026-01-03 15:35:39', '2026-01-03 15:45:28');
